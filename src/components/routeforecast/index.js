...
export default class Routeforecast extends Component {
	...
	fetchForecastData = () => {
		...
		var url = "http://api.openweathermap.org/data/2.5/forecast?lat=" + this.props.lat1 + "&lon=" + this.props.lon1 + "&appid=77637347dd30fe7831c5782342710ccf";
		$.ajax({
			url: url,
			dataType: "json",
			async: false,
		...
		url = "http://api.openweathermap.org/data/2.5/forecast?lat=" + this.props.lat2 + "&lon=" + this.props.lon2 + "&appid=77637347dd30fe7831c5782342710ccf";
		$.ajax({
			url: url,
			dataType: "json",
			async: false,
