...
export default class Route extends Component {
	...
	constructor(props){
		super(props);
		this.state.lon1 = "-0.03749985";
		this.state.lat1 = "51.520497918";
		this.state.lon2 = "-0.219937668477047";
		this.state.lat2 = "51.5161988759133";
		this.state.name1 = "QMUL";
		this.state.name2 = "Gym";
		this.state.time1 = "15:00:00";
		this.state.time2 = "18:00:00";
		this.state.temp1 = "";
		this.state.count = 0;
	}
	...
	render() {
		...
		return (
			<route>
				<name>Gym</name>
				<dropdown></dropdown>
				<route-text>{this.state.name1}: 5:00pm</route-text>
				<route-text>{this.state.name2}: 6:00pm</route-text>
				<block>a</block>
